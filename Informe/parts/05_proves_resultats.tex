...
Com es pot observar al gràfic (figura \ref{fig:grafic_mitja_KNN}), en el cas de les localitzacions dins botigues, la precisió mitjana en l'entorn sense usuaris és major que en el cas d'un entorn amb clients al voltant. En el cas dels passadissos observam un resultat particular. La mesura sense usuaris es més precisa fins K=8. Per valors majors, la l'error mitjà passa a ser menor en un entorn amb usuaris al voltant.
